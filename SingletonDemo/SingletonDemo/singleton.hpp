...
namespace Dot {
    ...
    protected:
        ...
        inline static void DestroyInstance(T*)
        {
    ...
    private:
        ...
        inline NoCreation& operator=(NoCreation const&)
        {
            return *this;
        }
    };
    ...
    protected:
        ...
        inline static void DestroyInstance(T* t)
        {
            delete t;
        }
    ...
    private:
        ...
        inline CreateUsingNew& operator=(CreateUsingNew const&)
        {
            return *this;
        }
    };
    ...
    private:
        ...
        inline CreateUsingStatic& operator=(CreateUsingStatic const&)
        {
            return *this;
        }
    };
    ...
    private:
        ...
        inline DefaultLifetime& operator=(DefaultLifetime const&)
        {
            return *this;
        }
    };
    ...
    private:
        ...
        inline PhoenixSingleton& operator=(PhoenixSingleton const&)
        {
            return *this;
        }
    };
    ...
    private:
        ...
        inline NoDestruction& operator=(NoDestruction const&)
        {
            return *this;
        }
    };
    ...
    protected:
        ...
        {
            Singleton::instance_ = static_cast<PointerType>(this);
